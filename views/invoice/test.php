...
<!--            <div class="mq-row">-->
<!--                <p class="mq-label">ФИО:</p>-->
<!--                <span>--><?//= $indigent->last_name . ' ' . $indigent->first_name . ' ' . $indigent->middle_name ?><!--</span>-->
<!--            </div>-->
<!--            <div class="mq-row">-->
<!--                <p class="mq-label">Адрес:</p>-->
<!--                <span>--><?//= $indigent->address ?><!--</span>-->
<!--            </div>-->
<!--            <div class="mq-row">-->
<!--                <p class="mq-label">Телефон:</p>-->
<!--                <span>--><?//= $indigent->phone ?><!--</span>-->
<!--            </div>-->
